# 교실 자리 배치 프로그램 V2.6.5 업데이트 로그

[2025-11-03] V2.6.5 업데이트
- 테마 시스템 안정화 : 테마 변경 시 모든 UI 요소 색상 일관성 유지
- 버그 수정 : 테마 적용 시 예외 처리 강화
- 코드 최적화 : 테마 관련 코드 정리 및 성능 개선
- UI 개선 : 테마 변경 시 부드러운 전환 효과

[2025-11-02] V2.6.4 업데이트
- 테마 시스템 개선 : 테마 변경 시 즉시 모든 UI 요소에 반영
- 테마 선택 UI 개선 : 중복 적용 방지 및 버튼 클로저 문제 해결
- 자동 반복 중 테마 색상 일관성 유지
- 하드코딩된 색상 제거 : 모든 UI 요소가 테마 시스템을 따르도록 개선
